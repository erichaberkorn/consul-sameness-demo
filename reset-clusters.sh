...
sleep 1
k3d cluster create c1 --registry-use k3d-registry.localhost:"$clusterPort"
sleep 1
k3d cluster create c2 --registry-use k3d-registry.localhost:"$clusterPort"
sleep 1
k3d cluster create c3 --registry-use k3d-registry.localhost:"$clusterPort"
sleep 1
k3d cluster create c4 --registry-use k3d-registry.localhost:"$clusterPort"
